...
void main() {
  group('Ranked Multiplayer & Server Authority Integration Tests', () {
    test('Shared match seed generates identical 7 rounds for both Player A and Player B', () {
    ...
    test('Authoritative Round Resolution: Higher score wins, equal score draws', () {
    ...
    test('Early Match Termination: Match finishes immediately when 4 wins are reached', () {
    ...
    test('Idempotent Elo Settlement: Consecutive settlements do not apply duplicate rating changes', () {
      var playerAMmr = 1000;
      var playerBMmr = 1000;
      var isSettled = false;
