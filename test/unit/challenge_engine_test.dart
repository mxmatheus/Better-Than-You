...
void main() {
  group('Challenge Engine — Cross-Challenge Determinism & Contract Safety', () {
    ...
    test(
      'Same seed generates identical configurations for all challenge types',
      () {
    ...
    test('Different seeds produce distinct configurations', () {
      final reactionDef = ChallengeRegistry.getDefinition(
      ...
      final precisionDef = ChallengeRegistry.getDefinition(
